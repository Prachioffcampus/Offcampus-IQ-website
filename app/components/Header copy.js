...
export default function Header() {
  ...
  return (
    <Popover className="relative bg-white font-jk">
      ...
      justify-between py-2 lg:justify-start md:space-x-10 px-6 md:px-10 lg:px-16">
        ...
        <div className="hidden lg:flex md:flex-1 lg:items-center lg:justify-between">
          ...
          <div className="flex items-center">
            <a
              href="#"
              className="inline-flex items-center justify-center border border-transparent bg-gradient-to-r from-orangeLight to-orangeDark px-4 py-1 text-base font-medium text-white shadow-sm hover:bg-gradient-to-r hover:from-orangeDark hover:to-orangeLight"
            >
            ...
            <div className="py-6 px-5">
              ...
              <div className="mt-6">
                ...
                <p className="mt-6 text-center text-base font-medium text-gray-500">
                  ...
                  <a
                    href="#"
                    className="text-indigo-600 hover:text-lightOrange"
                  >
